<?php
// GET INPUT
$inputStr = $_POST['inputLeft'];
$inputArr = explode(", ", $inputStr);
$city = $inputArr[0];
$countryCode = $inputArr[1];
...
<body class="container box-border mx-auto bg-gray-300">
  ...
  <main class="">
    ...
    <div id="compareLeft" class="mx-2">
      <div id="inputDivLeft" class="relative max-w-sm p-5 mx-auto mb-16 bg-gray-100 border rounded-lg shadow-md sm:mb-32 lg:mb-32 hover:shadow-lg">
        <div class="flex flex-wrap items-center justify-between py-2 border-b border-teal-500">
          ...
          <form name="form" action="" method="post">
            <input id="inputLeft" name="inputLeft" type="search" placeholder="City name" class="px-2 py-1 leading-tight text-left text-gray-700 bg-transparent border-none appearance-none focus:outline-none" />
          </form>

          <button id="submitLeft" value="Left" class="absolute right-0 px-3 py-1 text-sm text-white transform -translate-x-4 bg-teal-500 border-4 border-teal-500 rounded SUBMIT hover:bg-teal-700 hover:border-teal-700" type="button">
            Go
          </button>
        </div>
      </div>
      ...
      <div id="weatherBoxLeft" class="relative hidden">
        ...
        <div id="current" class="grid items-center max-w-xl grid-cols-6 grid-rows-3 gap-2 p-4 mx-auto text-center text-white bg-gray-800 rounded-lg shadow-lg">
          ...
          <!-- PRESSURE -->
          <div class="col-start-5 row-start-3 p-1 text-xs bg-gray-900 border border-gray-600 rounded-l-lg shadow">
          ...
          <div class="col-start-6 row-start-3 p-1 text-xs bg-gray-900 border border-gray-600 rounded-r-lg shadow">
            <p class="text-gray-600">
              land
            </p>
      ...
      <div id="weatherBoxRight" class="relative hidden">
        ...
        <div class="text-center">
          <div class="z-10 max-w-xs p-2 px-10 mx-auto -m-3 text-center text-white bg-gray-800 rounded-b-full shadow-md">
            ...
            <img id="statusIconRight" class="inline w-8" src="img/status/default.svg" alt="" title="" />
          </div>
        </div>
    ...
    <!-- IMAGE BAR -->
    <div id="photosBox" class="items-stretch hidden gap-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3"></div>
  </main>
    ...
    <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
      <div class="mt-8 md:mt-0 md:order-1">
        <p class="text-base leading-6 text-center text-gray-500">
          &copy; 2020
          <a class="hover:text-black" href="https://github.com/WiseCoding">WiseCoding</a>, MIT License.
        </p>
      </div>
